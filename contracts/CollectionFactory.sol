...
contract CollectionFactory{
    ...
    function createNFTCollection(string memory _artistName, string memory _artistSymbol) external returns (address collectionAddress) {
        ...
        Collection(collectionAddress).initialize(_artistName, _artistSymbol);
        ...
        emit collectionCreated(collectionAddress, _artistName, _artistSymbol);


    }

        function getOneCollection(uint _idCollection) external view returns (ArtistCollection memory) {
