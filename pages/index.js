...
export default function Home() {
  ...
  return (
    <div>
      ...
      {!user && (<h2 className="px-20 py-10 text-3xl">Metamask isn't connected</h2>)}

      {user && loadingState === 'loaded' && nfts.length === 0 && (<h1 className="px-20 py-10 text-3xl">No items in marketplace</h1>)}
